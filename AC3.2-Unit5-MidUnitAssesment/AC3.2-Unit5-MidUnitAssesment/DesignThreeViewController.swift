...
class DesignThreeViewController: UIViewController, CellTitled {
    ...
    func configureLandscapeConstraints() {
        ...
        let nameLabelConstraints = [
            ...
            nameLabel.topAnchor.constraint(equalTo: self.profileImageView.bottomAnchor, constant: -8.0),
            nameLabel.bottomAnchor.constraint(equalTo: likeLabel.topAnchor, constant: 8.0)
        ]
        
        let followLabelConstraints = [
            followLabel.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 8.0),
            followLabel.topAnchor.constraint(equalTo: self.nameLabel.bottomAnchor, constant: -8.0),
        ...
        let likeLabelConstraints = [
            ...
            likeLabel.trailingAnchor.constraint(equalTo: self.hexLabel.leadingAnchor, constant: -8.0)
        ]
        
        let hexLabelConstraints = [
            hexLabel.topAnchor.constraint(equalTo: nameLabel.bottomAnchor, constant: 8.0),
