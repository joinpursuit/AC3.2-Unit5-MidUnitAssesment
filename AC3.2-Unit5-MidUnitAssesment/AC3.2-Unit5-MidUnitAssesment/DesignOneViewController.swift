...
class DesignOneViewController: UIViewController, CellTitled {
    ...
    func setupViewHierarchy() {
        ...
        _ = [
            ...
            leftLabel,
            rightLabel
            ].map { $0.font = UIFont.systemFont(ofSize: subLabelFontSize) }
    ...
    func configureConstraints() {
        ...
        let leftGreen1Constraints = [
            ...
            leftGreen1.widthAnchor.constraint(equalToConstant: 125.0),
            leftGreen1.heightAnchor.constraint(equalToConstant: 50.0)
        ]
        
        let leftGreen2Constraints = [
            leftGreen2.bottomAnchor.constraint(equalTo: leftGreen1.topAnchor, constant: -barMargin),
            ...
            leftGreen2.heightAnchor.constraint(equalTo: leftGreen1.heightAnchor)
        ]
        
        let leftYellow1Constraints = [
            leftYellow1.bottomAnchor.constraint(equalTo: leftGreen2.topAnchor, constant: -barMargin),
            ...
            leftYellow1.heightAnchor.constraint(equalTo: leftGreen1.heightAnchor)
        ]
        
        let leftYellow2Constraints = [
            leftYellow2.bottomAnchor.constraint(equalTo: leftYellow1.topAnchor, constant: -barMargin),
            ...
            leftYellow2.heightAnchor.constraint(equalTo: leftGreen1.heightAnchor)
        ]
        
        let leftRedConstraints = [
            leftRed.bottomAnchor.constraint(equalTo: leftYellow2.topAnchor, constant: -barMargin),
            ...
            leftRed.heightAnchor.constraint(equalTo: leftGreen1.heightAnchor)
        ]
        ...
        let rightGreen1Constraints = [
            ...
            rightGreen1.widthAnchor.constraint(equalToConstant: 125.0),
            rightGreen1.heightAnchor.constraint(equalToConstant: 50.0)
        ]
        
        let rightGreen2Constraints = [
            rightGreen2.bottomAnchor.constraint(equalTo: rightGreen1.topAnchor, constant: -barMargin),
            ...
            rightGreen2.heightAnchor.constraint(equalTo: rightGreen1.heightAnchor)
        ]
        
        let rightYellow1Constraints = [
            rightYellow1.bottomAnchor.constraint(equalTo: rightGreen2.topAnchor, constant: -barMargin),
            ...
            rightYellow1.heightAnchor.constraint(equalTo: rightGreen1.heightAnchor)
        ]
        
        let rightYellow2Constraints = [
            rightYellow2.bottomAnchor.constraint(equalTo: rightYellow1.topAnchor, constant: -barMargin),
            ...
            rightYellow2.heightAnchor.constraint(equalTo: rightGreen1.heightAnchor)
        ]
        
        let rightRedConstraints = [
            rightRed.bottomAnchor.constraint(equalTo: rightYellow2.topAnchor, constant: -barMargin),
            ...
            rightRed.heightAnchor.constraint(equalTo: rightGreen1.heightAnchor)
        ]
