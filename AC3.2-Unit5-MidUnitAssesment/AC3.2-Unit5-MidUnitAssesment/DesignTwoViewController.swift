...
class DesignTwoViewController: UIViewController, CellTitled {
  ...
  func configureConstraints() {
    ...
    let labelConstraints = [
      smittenKittenLabel.topAnchor.constraint(equalTo: self.topLayoutGuide.bottomAnchor, constant: 16.0),
      smittenKittenLabel.centerXAnchor.constraint(equalTo: self.view.centerXAnchor)
    ]
    scrollView.contentSize = smittenKittenImageView.intrinsicContentSize
