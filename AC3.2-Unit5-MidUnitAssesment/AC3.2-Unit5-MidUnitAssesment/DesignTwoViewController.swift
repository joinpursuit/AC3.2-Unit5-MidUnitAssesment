...
class DesignTwoViewController: UIViewController, CellTitled {
    ...
    func configureConstraints() {
        ...
        let imageConstraints = [
            ...
            smittenKittenImageView.widthAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 1.0),
            smittenKittenImageView.heightAnchor.constraint(equalTo: self.view.heightAnchor, multiplier: 1.0),
        ]
