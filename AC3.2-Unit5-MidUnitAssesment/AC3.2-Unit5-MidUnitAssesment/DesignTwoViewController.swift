...
class DesignTwoViewController: UIViewController, CellTitled {
    ...
    func configureConstraints() {
        ...
        let labelConstraints = [
            smittenKittenLabel.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 70.0),
            smittenKittenLabel.centerXAnchor.constraint(equalTo: self.view.centerXAnchor)
           
        ]
        
        let scrollViewConstraints = [
            scrollView.topAnchor.constraint(equalTo: self.smittenKittenLabel.bottomAnchor, constant: 8.0),
        ...
        let imageConstraints = [
            ...
            smittenKittenImageView.leadingAnchor.constraint(equalTo: self.scrollView.leadingAnchor, constant: 0),
