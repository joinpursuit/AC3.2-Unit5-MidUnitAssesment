...
//        self.edgesForExtendedLayout = .all
        ...
        self.smittenKittenLabel.textAlignment = .center
    ...
    func configureConstraints() {
        ...
        let labelConstraints = [
            smittenKittenLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 68),
            smittenKittenLabel.leadingAnchor.constraint(equalTo: self.view.leadingAnchor),
            smittenKittenLabel.trailingAnchor.constraint(equalTo: self.view.trailingAnchor),
            smittenKittenLabel.centerXAnchor.constraint(equalTo: self.view.centerXAnchor)
        ]
        
        let scrollViewConstraints = [
            scrollView.topAnchor.constraint(equalTo: self.smittenKittenLabel.bottomAnchor, constant: 4),
        ...
        let imageConstraints = [
            smittenKittenImageView.topAnchor.constraint(equalTo: self.scrollView.topAnchor, constant: -68),
